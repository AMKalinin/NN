'''Модуль моделей нейронок (разные оптимизаторы)
    Реализован только классический градиентный спуск, 
    у новых моделей потребуется переписать только обратное распространение ошибки'''
...
class model():
    ...
    def init_w(self):
        '''Случайная инициализация весов связей'''
        pass
